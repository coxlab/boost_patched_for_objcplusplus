...
# define BOOST_PYTHON_BINARY_OPERATION(id_, rid, expr)       \
namespace detail                                            \
{                                                           \
  template <>                                               \
  struct operator_l<op_##id_>                                \
  {                                                         \
      ...
      static char const* name() { return "__" #id_ "__"; }   \
  };                                                        \
                                                            \
  template <>                                               \
  struct operator_r<op_##id_>                                \
  {                                                         \
      template <class L, class R>                           \
      struct apply                                          \
      {                                                     \
...
# define BOOST_PYTHON_BINARY_OPERATOR(id_, rid, op)      \
BOOST_PYTHON_BINARY_OPERATION(id_, rid, l op r)          \
namespace self_ns                                       \
{                                                       \
  template <class L, class R>                           \
  inline detail::operator_<detail::op_##id_,L,R>         \
  operator op(L const&, R const&)                       \
  {                                                     \
      return detail::operator_<detail::op_##id_,L,R>();  \
  }                                                     \
}
...
# define BOOST_PYTHON_INPLACE_OPERATOR(id_, op)                  \
namespace detail                                                \
{                                                               \
  template <>                                                   \
  struct operator_l<op_##id_>                                    \
...
{                                                               \
  template <class R>                                            \
  inline detail::operator_<detail::op_##id_,self_t,R>            \
  operator op(self_t const&, R const&)                          \
  {                                                             \
      return detail::operator_<detail::op_##id_,self_t,R>();     \
  }                                                             \
}
...
# define BOOST_PYTHON_UNARY_OPERATOR(id_, op, func_name)         \
namespace detail                                                \
{                                                               \
  template <>                                                   \
  struct operator_1<op_##id_>                                    \
  {                                                             \
      template <class T>                                        \
      struct apply                                              \
      {                                                         \
...
namespace self_ns                                               \
{                                                               \
  inline detail::operator_<detail::op_##id_>                     \
  func_name(self_t const&)                                      \
  {                                                             \
      return detail::operator_<detail::op_##id_>();              \
  }                                                             \
}
